        ...
        <>
            <div className='w-full h-[800px] text-white'>
                <div className='w-full h-full'>
                    ...
                    />
                    <div className='absolute w-full top-[30%] ml-6 p-4 md:p-8'>
                        <h1 className='text-3xl md:text-5xl font-bold'>{movie?.name || movie?.original_title}</h1>
                        <div>
                        <div className='my-4'>
                            ...
                            >
                                <FontAwesomeIcon icon={faPlay}
                                                 style={{color: "#121212", marginRight: "5px"}}/> Play
                            </button>
                                </Link>
                            ...
                            transition-colors duration-0 ease-in-out hover:bg-gray-500 hover:bg-opacity-30 hover:text-white'>
                                <FontAwesomeIcon icon={faCircleInfo}
                                                 style={{color: "#ffffff", marginRight: "5px"}}/> More
                                Information
                            </button>
                            </Link>
                            </div>
